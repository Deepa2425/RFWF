...
public class BaseTestNGPageVerifyUNPwd {

	public static WebDriver edriver;
	public static EventFiringWebDriver driver;

	public BaseTestNGPageVerifyUNPwd() {
	...
	public void invokeBrowser() throws InterruptedException {
		...
		String url = g.getExcelCellValue(xlPath, sheetName, 8, 1);
		String un = g.getExcelCellValue(xlPath, sheetName, 20, 2);
		String pwd = g.getExcelCellValue(xlPath, sheetName, 20, 3);

		System.setProperty("webdriver.chrome.driver", serverFile);
		...
		capabilities.setCapability("chrome.binary", serverFile);
		capabilities.setCapability(ChromeOptions.CAPABILITY, options);
