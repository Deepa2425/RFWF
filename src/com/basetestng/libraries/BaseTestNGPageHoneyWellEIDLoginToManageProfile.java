...
public class BaseTestNGPageHoneyWellEIDLoginToManageProfile {

	public static WebDriver edriver;
	public static EventFiringWebDriver driver;

	public BaseTestNGPageHoneyWellEIDLoginToManageProfile() {
	...
	public void invokeBrowser() throws InterruptedException {
		...
		String url = g.getExcelCellValue(xlPath, sheetName, 14, 1);
		String un = g.getExcelCellValue(xlPath, sheetName, 14, 2);
		String pw = g.getExcelCellValue(xlPath, sheetName, 14, 3);
		...
		driver.get(url);driver.findElement(By.xpath(".//*[@id='UserName']")).clear();
		driver.findElement(By.xpath(".//*[@id='UserName']")).sendKeys(un);
		driver.findElement(By.xpath(".//*[@id='Password']")).clear();
		driver.findElement(By.xpath(".//*[@id='Password']")).sendKeys(pw);
		driver.findElement(By.xpath(".//*[@id='Backend_LoginBtn']")).click();
		Thread.sleep(5000);
	}
