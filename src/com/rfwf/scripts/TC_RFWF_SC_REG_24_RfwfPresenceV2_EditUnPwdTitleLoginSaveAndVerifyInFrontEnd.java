...
public class TC_RFWF_SC_REG_24_RfwfPresenceV2_EditUnPwdTitleLoginSaveAndVerifyInFrontEnd
		extends BaseTestNGPageSiteCoreV2 {
	@Test
	public void textTC_RFWF_SC_REG_24_RfwfPresenceV2_EditUnPwdTitleLoginSaveAndVerifyInFrontEnd2()
		...
		String folderNameToCreate = g.getExcelCellValue(xlPath, sheetName, 794, 2);
		...
		try {
			...
			b = true;
			g.setExcelCellValue(xlPath, sheetName, 792, 3, "PASS");
			g.setExcelCellValue(xlPath, sheetName, 792, 4, "Executed on - " + date1);

		} catch (Exception e1) {
			g.setExcelCellValue(xlPath, sheetName, 792, 3, "FAIL");
			g.setExcelCellValue(xlPath, sheetName, 792, 4, date1);
		} finally {
			if (!b) {
				...
				g.setExcelCellValue(xlPath, sheetName, 792, 3, "FAIL");
				g.setExcelCellValue(xlPath, sheetName, 792, 4, "Executed on - " + date1);
				g.setExcelCellValue(xlPath, sheetName, 792, 5, screenShot + v + "_" + date1);
