...
public class TC_RFWF_SC_logoff_22_publishSiteAndVerifyFront extends BaseTestNGPageSiteCoreV2 {
	@Test
	public void textTC_RFWF_SC_logoff_22_publishSiteAndVerifyFront() throws InterruptedException {
...
iFT.clickOK();
			...
			Thread.sleep(20000);
			 ...
			 driver.get("https://www.gmail.com");
				...
				b = true;
			g.setExcelCellValue(xlPath, sheetName, 2652, 3, "PASS");
			g.setExcelCellValue(xlPath, sheetName, 2652, 4, "Executed on - " + date1);

		} catch (Exception e1) {
			g.setExcelCellValue(xlPath, sheetName, 2652, 3, "FAIL");
			g.setExcelCellValue(xlPath, sheetName, 2652, 4, date1);
		} finally {
			if (!b) {
				...
				g.setExcelCellValue(xlPath, sheetName, 2652, 3, "FAIL");
				g.setExcelCellValue(xlPath, sheetName, 2652, 4, "Executed on - " + date1);
				g.setExcelCellValue(xlPath, sheetName, 2652, 5, screenShot + v + "_" + date1);
