...
public class TC_RFWF_SC_FP_36_VerifyPasswordUpdation extends BaseTestNGPageSiteCoreV2 {
	@Test
	public void textTC_RFWF_SC_FP_36_VerifyPasswordUpdation() throws InterruptedException {
		...
		String updateMsg = g.getExcelCellValue(xlPath, sheetName, 898, 2);
