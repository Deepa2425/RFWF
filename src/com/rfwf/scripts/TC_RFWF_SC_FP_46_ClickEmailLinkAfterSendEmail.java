...
public class TC_RFWF_SC_FP_46_ClickEmailLinkAfterSendEmail extends BaseTestNGPageSiteCoreV2 {
	@Test
	public void textTC_RFWF_SC_FP_46_ClickEmailLinkAfterSendEmail() throws InterruptedException {
...
try {
			...
			Thread.sleep(10000);
				...
				/*		fE.verifyInputText("txtUsername2","");
						fE.verifyInputText("txtUnlockCode", "");
						fE.verifySubmitButtonPositive("Submit");
			*/	b = true;
