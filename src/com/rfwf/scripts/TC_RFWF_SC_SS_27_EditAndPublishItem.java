...
public class TC_RFWF_SC_SS_27_EditAndPublishItem extends BaseTestNGPageSiteCoreV2 {
	@Test(priority = 1)
	public void textTC_RFWF_SC_SS_27_EditAndPublishItem() throws InterruptedException {
		...
		String folderNameToSelect = g.getExcelCellValue(xlPath, sheetName, 3167, 2);
		String subFolder = g.getExcelCellValue(xlPath, sheetName, 3168, 2);
		String folderNameToCreate = g.getExcelCellValue(xlPath, sheetName, 3169, 2);

		String secure = g.getExcelCellValue(xlPath, sheetName, 3170, 2);
		String templateName = g.getExcelCellValue(xlPath, sheetName, 3171, 2);
		String tenantName = g.getExcelCellValue(xlPath, sheetName, 3172, 2);
		String subElement = g.getExcelCellValue(xlPath, sheetName, 3173, 2);
		String pageLayout = g.getExcelCellValue(xlPath, sheetName, 3174, 2);
		String frontEndUrlStrt = g.getExcelCellValue(xlPath, sheetName, 3175, 2);
...
cE.switchBackTpParentWindow();
			...
			// done
			b = true;
			g.setExcelCellValue(xlPath, sheetName, 3167, 3, "PASS");
			g.setExcelCellValue(xlPath, sheetName, 3167, 4, "Executed on - " + date1);

		} catch (Exception e1) {
			g.setExcelCellValue(xlPath, sheetName, 3167, 3, "FAIL");
			g.setExcelCellValue(xlPath, sheetName, 3167, 4, date1);
		} finally {
			if (!b) {
				...
				g.setExcelCellValue(xlPath, sheetName, 3167, 3, "FAIL");
				g.setExcelCellValue(xlPath, sheetName, 3167, 4, "Executed on - " + date1);
				g.setExcelCellValue(xlPath, sheetName, 3167, 5, screenShot + v + "_" + date1);
