...
public class TC_RFWF_SC_SS_38_AlterAndPublish extends BaseTestNGPageSiteCoreV2 {
	@Test(priority = 1)
	public void textTC_RFWF_SC_SS_38_AlterAndPublish() throws InterruptedException {
		...
		try {
			...
			/*
			 * cE.doubleClick1(templateName); hP.editField(1, "username");
			 */
			cE.expandFolder1(folderNameToCreate, 2);
			cE.expandFolder1(folderNameToCreate, 3);
			cE.expandFolder1(folderNameToCreate, 5);
			cE.doubleClick1("HighLight");
			hP.editField(1, "NewHeading");
			hP.BrowseRedirectionLink("Highlight Image:");
			iFT.switchFrame();
			System.out.println("frame chosen");
			Thread.sleep(10000);
			img1 = eE.choosehighlightImge("cover", 1);
