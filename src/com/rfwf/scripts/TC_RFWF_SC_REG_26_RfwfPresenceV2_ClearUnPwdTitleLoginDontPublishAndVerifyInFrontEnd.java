...
public class TC_RFWF_SC_REG_26_RfwfPresenceV2_ClearUnPwdTitleLoginDontPublishAndVerifyInFrontEnd extends BaseTestNGPageSiteCoreV2 {
	@Test
	public void textTC_RFWF_SC_REG_26_RfwfPresenceV2_ClearUnPwdTitleLoginDontPublishAndVerifyInFrontEnd() throws InterruptedException {
		...
		String frontEndURL = g.getExcelCellValue(xlPath, sheetName1, 23, 1);
		...
		try {
	        ...
	        cE.verifyFrontEndFieldsNegative("txtConfirmationPassword","");
	     
			
			b = true;
			g.setExcelCellValue(xlPath, sheetName, 286, 3, "PASS");
			g.setExcelCellValue(xlPath, sheetName, 286, 4, "Executed on - " + date1);

		} catch (Exception e1) {
			g.setExcelCellValue(xlPath, sheetName, 286, 3, "FAIL");
			g.setExcelCellValue(xlPath, sheetName, 286, 4, date1);
		} finally {
			if (!b) {
				...
				g.setExcelCellValue(xlPath, sheetName, 286, 3, "FAIL");
				g.setExcelCellValue(xlPath, sheetName, 286, 4, "Executed on - " + date1);
				g.setExcelCellValue(xlPath, sheetName, 286, 5,
