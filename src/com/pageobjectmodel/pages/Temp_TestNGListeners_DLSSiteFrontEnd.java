...
public class Temp_TestNGListeners_DLSSiteFrontEnd extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult result) {
		...
		BaseTestNGPageDLSSiteFrontEnd s = (BaseTestNGPageDLSSiteFrontEnd) result.getInstance();
		Class<? extends BaseTestNGPageDLSSiteFrontEnd> v = s.getClass();
