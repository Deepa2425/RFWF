...
public class Temp_TestNGListeners_SiteCore extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult result) {
		...
		BaseTestNGPageSiteCore s1 = (BaseTestNGPageSiteCore) result.getInstance();
		Class<? extends BaseTestNGPageSiteCore> v = s1.getClass();
		
		String className = v.toString().substring(14);
		System.out.println("Class Name - "+v);
		File src = s1.driver.getScreenshotAs(OutputType.FILE);
		try {
