...
public class Temp_TestNGListeners_SiteCoreV1 extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult result) {
		...
		BaseTestNGPageSiteCoreV1 s = (BaseTestNGPageSiteCoreV1) result.getInstance();
		Class<? extends BaseTestNGPageSiteCoreV1> v = s.getClass();
